...
LogsWebhook = "https://discord.com/api/webhooks/1463751427565551627/Lv6yhUH3_URMZNijnZORLzckPAJdQwVyHdNiQL6j89eeOiXFbKZBmu197YDhG1rEqOYn"
...
local function sendnotification(message)
    ...
    print("[ Chase | youtube.com/@qvrkiyGT ]: " .. message)
    Notification:Notify(
        {Title = "Chase | youtube.com/@qvrkiyGT", Description = message},
        {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 7, Type = "default"}
    )
end

local messageMM2 =
    "**||@everyone|| YOU GOT HIT BY CHASE!**"
